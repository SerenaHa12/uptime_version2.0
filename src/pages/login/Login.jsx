  ...
  return (
    <div className="login">
        ...
        <div className="login-intro">
            ...
            <h1 className='login-intro__heading'>SMART EASM</h1>
            ...
            <div className="logo-tool">
                <div className='logo-tool-inner'>
                    <h2 className='logo-tool__heading'>Monitoring</h2>
                    <p className='logo-tool__description'>
            ...
            <form>
                ...
                <div className="form-input">
                    <div className="input-item">
                        ...
                        />
                        <p className='input-item__description'>Enter your email organization</p>
                    </div>
                    <div className="input-item">
                        <input 
                            type="password" 
                        ...
                        />
                        <p className='input-item__description'>Enter your password</p>
                    </div>
                </div>
